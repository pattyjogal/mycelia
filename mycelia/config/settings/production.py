...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['whitneyyoungscience.com'])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='mycelia <noreply@whitneyyoungscience.com>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[mycelia] ')
